...
public class AddAttachmentForm extends ActivityForm {

    @NotBlank
    private final String name;


    public AddAttachmentForm(@NotBlank String description, @NotBlank String createdById, @NotBlank String name) {
        super(description, createdById);
        this.name = name;
    }

    public AddAttachmentForm(@NotBlank String createdById, @NotBlank String name) {
        super(createdById);
        this.name = name;
    }
    ...
    public ActivityType getType() {
        return ActivityType.ADDED_ATTACHMENT;
    }
