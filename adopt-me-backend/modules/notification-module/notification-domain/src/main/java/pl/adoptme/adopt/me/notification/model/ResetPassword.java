...
public class ResetPassword extends Notification {
    ...
    @Builder
    public ResetPassword(String id, String email, String firstName, String lastName, boolean sent,
                         LocalDateTime createdOn, String createdById, LocalDateTime lastAttemptedOn,
